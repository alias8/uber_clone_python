"""In-memory persistence. Swapped for SQLAlchemy 2.0 async sessions against Postgres in M2 —
the method names here (save/find_by_id/exists_by_*) are chosen to make that swap mechanical."""

from __future__ import annotations

import threading

from ride_service.models import Driver, Rating, Ride, RideStatus, User
