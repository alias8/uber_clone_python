...
class Driver:
    ...
    avg_rating: float | None = None
    rating_count: int = 0
    # No lat/lng field, matching uber_clone's Driver JPA entity — location lives only in
    # Redis's geo-index (drivers:locations), never in Postgres. See repositories/driver.py.
