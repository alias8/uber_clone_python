...
window, per key" behavior for M1. Replaced by the `limits` package against Redis in M3, which
also makes rate limits work across multiple instances (this one doesn't).
"""
